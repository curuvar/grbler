function createObjectFromGCode( inGCode )
{
  // inGCode descriptions come from:
  ...
  $('#console').append('\n<span style="color: red;">--------------New inGCode Loaded--------------</span>\n');
  ...
  // take max X and Y and scale them to fit in #render-area

  console.log( "render-area width:", $('#render-area').width(), "height:", $('#render-area').height() );


  var scaleX = $('#render-area').width()  / dX;
  var scaleY = $('#render-area').height() / dY;
  var scale  = 1;
